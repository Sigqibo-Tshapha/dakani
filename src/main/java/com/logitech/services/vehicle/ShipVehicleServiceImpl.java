...
@Service("shipSeviceImpl")
public class ShipVehicleServiceImpl implements IVehicleService{
    IVehicleRepository vehicleRepository;

    @Autowired
    public ShipVehicleServiceImpl(IVehicleRepository vehicleRepository) {
